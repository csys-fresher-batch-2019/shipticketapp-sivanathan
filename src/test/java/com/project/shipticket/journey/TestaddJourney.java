...
public class TestaddJourney {
	...
	public static void getdatemethod() throws Exception {
		...
		logger.input("ENTER THE DESTINATION FROM DATE AND DESTINATION TO DATE DETAILS:\n");
		logger.input("Enter the from date(YYYY-MM-DD):\n");
		String dob = scn4.next();// 2020-01-01
		LocalDate date1 = LocalDate.parse(dob);
		logger.input("Enter the to date(YYYY-MM-DD):\n");
