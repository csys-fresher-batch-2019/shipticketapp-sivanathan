...
public class UserDAOImplementation implements UserDAO {
	...
	public void addUser(User a) {
		/*Jdbi jdbi=TestConnection.getJdbi();
		//ServiceShipTicket service=jdbi.onDemand(service.class);
...
try(PreparedStatement smt = com.prepareStatement(sql);)
{
	...
	public void resetUser(User a) {
		...
		{	//smt3 = com.prepareStatement(sql3);
			...
			logger.error("connection statement exception" + e);
		}
	}
